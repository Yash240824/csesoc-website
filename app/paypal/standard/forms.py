...
from app.paypal.standard.conf import *
from app.paypal.standard.widgets import ValueHiddenInput, ReservedValueHiddenInput
from app.paypal.standard.conf import (POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT, 
    RECEIVER_EMAIL)
...
class PayPalSharedSecretEncryptedPaymentsForm(PayPalEncryptedPaymentsForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from app.paypal.standard.helpers import make_secret
